...
Puppet 4.3 or higher compatible is located at [puppet4_3_data branch](https://github.com/biemond/biemond-oradb/tree/puppet4_3_data) and uses the latest features of puppet 4 like
- Strong data typing
- Internal hiera module data
- uses Facts array
- epp templating instead of erb

Puppet 3,4 compatible, you have to use/download the latest 2.x version of this oradb module
